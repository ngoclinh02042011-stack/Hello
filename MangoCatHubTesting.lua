...
local function NotificacaoNightMystic(titulo, mensagem)
    ...
    if not success then
        warn("[MangoCatHub Hub] Erro ao exibir notificação")
    end
end
...
-- GỌI THỬ ĐỂ TEST:
-- ==========================================
NotificacaoNightMystic("Mango Cat Hub Notification ", "Hi")
task.wait(0.8)
NotificacaoNightMystic("Mango Cat Hub Thông Báo ", "Chào")

local HttpService = Services.HttpService
local FolderName = "MangoCatHub.json"
...
local Window = redzlib:MakeWindow({
    ...
    SaveFolder = true,
    Image = "87996610624342"
})
-- Tạo nút bấm bằng hàm gốc của thư viện (100% không lỗi ẩn/hiện)
local MinimizeButton = Window:AddMinimizeButton({
    Button = { 
        Image = "rbxassetid://87996610624342", -- Dùng ID ảnh bạn chọn
        BackgroundTransparency = 1,
        Name = "MangoCatHub_On_Top" -- Đặt tên đúng yêu cầu
    },
...
Discord:AddDiscordInvite({
    Name = "ThanhDuy X Mango Cat Hub Script | Community✅",
    Description = "Join Discord to receive updates",
    Logo = "rbxassetid://87996610624342",
    Invite = "https://discord.gg/GWEjTTGnK"
})
spawn(function()
    pcall(function()
        while wait() do
